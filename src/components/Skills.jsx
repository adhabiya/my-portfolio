...
const SKILLS_SECTIONS = [
    ...
    { icon: <Layers className="w-6 h-6" />, title: "Frameworks & Libraries", tags: ["React", "Tailwind CSS", "NumPy", "Pandas","Bootstrap","Laravel(PHP)","Django"] },
    { icon: <Terminal className="w-6 h-6" />, title: "Tools & Platforms", tags: ["Git", "GitHub", "VS Code", "Jupyter Notebook"] },
    { icon: <Sparkles className="w-6 h-6" />, title: "Interests", tags: ["Competitive Programming", "Database-Driven Applications", "Full-Stack Development", "Web Application Development"] },
];
