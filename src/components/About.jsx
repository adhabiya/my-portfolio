...
const SOCIAL_LINKS = [
  {
    href: "https://github.com/adhabiya",
    icon: <Github className="w-5 h-5" />,
    title: "GitHub",
  },
  {
    href: "https://www.linkedin.com/in/adhabiya-ummer/",
...
const RESUME_URL =
  "https://drive.google.com/file/d/11bj9stA7hGvvODaLGHVNvuZvDxcBI_cZ/view";
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-5xl px-4 py-12">
        ...
        <motion.div
          ...
          tabIndex={0}
          aria-label="Profile photo of Adhabiya Ummer"
        >
          <img
            src="/assets/portfolio pic.png"
            alt="Adhabiya Ummer"
            loading="lazy"
            decoding="async"
        ...
        >
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-4 text-center md:text-left">
            I'm a passionate MCA student with a strong interest in{" "}
            <span className="text-foreground font-medium">
               web development
            </span>{" "}
            and building practical, user-friendly applications. I enjoy designing clean
  interfaces, developing reliable backend logic, and working with databases.
  My journey in tech combines solid academic foundations with hands-on web
