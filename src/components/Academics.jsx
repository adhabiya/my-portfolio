...
const ACADEMICS_DATA = [
  {
    logo: "/assets/logos/logorcss.png",
    alt: "RCSS Logo",
  ...
  {
    logo: "/assets/logos/logorcmas.png",
    alt: "RCMAS Logo",
    title: "RAJAGIRI COLLEGE OF MANAGEMENT AND APPLIED SCIENCES",
    link: "https://www.rajagiricollege.edu.in/",
  ...
  {
    logo: "/assets/logos/logommhss.png",
    alt: "MMHSS Logo",
    title: "MARY MATHA HIGHER SECONDARY SCHOOL",
    link: "https://marymathahssthrikkakara.com/",
    program: "KERALA STATE (Class XII)",
    year: "2021",
    scoreLabel: "Percentage",
    score: "95.3%",
  },
 {
    logo: "/assets/logos/logocps.png",
    alt: "CPS Logo",
    title: "COCHIN PUBLIC SCHOOL",
    link: "https://cochinpublicschool.ac.in/",
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            <motion.p variants={itemVariants} className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
                My academic journey focuses on computer applications, blending academic learning with hands-on experience in programming and web development. The following institutions and milestones have shaped my technical foundation.
            </motion.p>
        </motion.div>
