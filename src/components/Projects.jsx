...
function ProjectsComponent() {
  const projectsData = useMemo(
    () => [
      { title: "Online Lawn and Garden Store", desc: "Developed a dynamic web-based e-commerce application that allows users to browse and purchase lawn and garden products. Implemented backend functionality using PHP and MySQL, with a responsive and user-friendly interface built using HTML and CSS", tags: ["PHP", "MySQL", "HTML", "CSS", "Web Development"], links: [{ type: "code", href: "" }] },
      { title: "Interior Designing Consultancy System", desc: "Built a web-based application using Django and MySQL that enables customers to explore, customize, and purchase interior design products. Focused on clean UI design, efficient database handling, and smooth user interaction using HTML and CSS.", tags: ["Python", "Django", "MySQL", "HTML", "CSS", "Web Application"], links: [{ type: "code", href: ""}] },
    ],
    []
  );
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col items-center text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-center mb-10">
               Here are some of the web-based projects I’ve developed using Laravel and Django, showcasing my skills in building responsive interfaces, managing databases, and delivering practical, user-focused solutions.
            </p>
        </motion.div>
